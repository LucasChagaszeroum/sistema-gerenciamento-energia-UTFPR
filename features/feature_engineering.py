...
class FeatureEngineer:
    ...
    def processar_features(df: pd.DataFrame, train_ratio: float = 0.8) -> tuple[pd.DataFrame, int]:
        # Ordena a série temporal pelo timestamp
        ...
        # Estatísticas móveis (média, desvio padrão e EWMA)
        ...
        # Atributos cíclicos e interações de temperatura com hora
        ...
        # Remove linhas iniciais contendo valores nulos gerados pelos lags
